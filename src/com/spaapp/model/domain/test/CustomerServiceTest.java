...
public class CustomerServiceTest {
    ...
    public void testAddAndGetCustomer() {
        Customer customer = new Customer(0, "John Doe", "123 Main St", "123-456-7890", "john@example.com", "john_doe");
    ...
    public void testUpdateCustomer() {
        // Add a customer
        Customer initialCustomer = new Customer(0, "John Doe", "123 Main St", "123-456-7890", "john@example.com", "john_doe");
        customerService.addCustomer(initialCustomer);

        // Update the customer
        Customer updatedCustomer = new Customer(0, "John Doe", "456 Oak St", "987-654-3210", "john@example.com", "john_doe");
    ...
    public void testUpdateNonexistentCustomer() {
        ...
        Customer updatedCustomer = new Customer(0, "Nonexistent User", "456 Oak St", "987-654-3210", "nonexistent@example.com", "nonexistent_user");
