...
public class SpaServiceTest {
    ...
    public void testCreateAndGetSpaService() {
        ...
        SpaService retrievedService = spaService.readSpaService(100);
    ...
    public void testUpdateSpaService() {
        ...
        assertTrue(spaService.updateSpaService(3, "New description", 90.0)); // Assuming the service_id is 1

        // Get the updated spa service
        SpaService updatedService = spaService.readSpaService(100); // Assuming the service_id is 1
