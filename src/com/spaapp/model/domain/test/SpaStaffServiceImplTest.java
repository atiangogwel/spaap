...
public class SpaStaffServiceImplTest {
    ...
    public void testUpdateSpaStaff() {
        // Add a spa staff
        SpaStaff initialSpaStaff = new SpaStaff(8, "john_doe", "password", "john@example.com", "John Doe");
        spaStaffService.addSpaStaff(initialSpaStaff);

        // Update the spa staff
        SpaStaff updatedSpaStaff = new SpaStaff(8, "john_doe_updated", "new_password", "john@example.com", "John Doe");
    ...
    public void testDeleteSpaStaff() {
        ...
        spaStaffService.deleteSpaStaff(10);
    }
